...
class Meta:
    ...
    def get_partition(self, offset):
        ...
        return {
            **{
                f"node_weight_{offset + i}": self.node_weights[i]
                for i in range(len(self.partition_ids))
            },
            **{
                f"edge_weight_{offset + i}": self.edge_weights[i]
                for i in range(len(self.partition_ids))
            },
        }, offset + len(self.partition_ids)
